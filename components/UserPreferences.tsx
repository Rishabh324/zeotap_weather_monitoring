...
const UserPreferences = () => {
  ...
  return (
    <div className="bg-blue-300 w-fit p-4 rounded shadow-md mb-4">
      <div className="mb-4">
      ...
      <button onClick={handleSave} className="bg-blue-500 hover:opacity-55 text-white py-2 px-4 rounded">Save Preferences</button>
    </div>
  );
};
